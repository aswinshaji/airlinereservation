...
public class userCreation extends javax.swing.JInternalFrame {
    ...
    public userCreation() {//this method enables initial components and autoID
        initComponents();
        autoID();
    }
    Connection con;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//this method allows ID, name, username, and password to be entered
    ...
    public void autoID() {//this method enables autoID
